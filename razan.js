...
module.exports = razan = async (razan, m, chatUpdate, store) => {
  try {
    ...
    const groupMetadata = m.isGroup
      ? await razan.groupMetadata(m.chat).catch((e) => {})
      : "";
    ...
    if (db.data.settings[botNumber].autobio) {
      ...
      if (new Date() * 1 - setting.status > 1000) {
        ...
        await razan.updateProfileStatus(
    ...
    if (db.data.chats[m.chat].antilink) {
      if (budy.match(`chat.whatsapp.com`)) {
        ...
        let gclink =
          `https://chat.whatsapp.com/` + (await razan.groupInviteCode(m.chat));
        ...
        razan.groupParticipantsUpdate(m.chat, [m.sender], "remove");
      }
    }
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`;
          this.suit[id] = {
            chat: await razan.sendText(m.chat, caption, m, {
            ...
            waktu: setTimeout(() => {
              if (this.suit[id])
                razan.sendText(m.chat, `_Waktu suit habis_`, m);
              delete this.suit[id];
            }, 60000),
            poin,
            poin_lose,
      ...
      case "sc":
        {
          m.reply(
            "Script : https://github.com/DikaArdnt/razan-Morou\n\n Dont Forget Give Star\n\nDonate : 6281615075793 (Link Aja)\nSaweria : https://saweria.co/DikaArdnt\nPaypal : https://www.paypal.me/Cakhaho\n\n Dont Forget Donate"
          );
        }
        break;
      case "chat":
      ...
      case "family100":
        {
          ...
          _family100["family100" + m.chat] = {
            id: "family100" + m.chat,
            pesan: await razan.sendText(m.chat, hasil, m),
            ...random,
      ...
      case "react":
        {
          ...
          razan.sendMessage(m.chat, reactionMessage);
        }
        break;
      case "join":
        {
      ...
      case "setppbot":
        {
          ...
          if (/webp/.test(mime))
            throw `Kirim/Reply Image Dengan Caption ${prefix + command}`;
          let media = await razan.downloadAndSaveMediaMessage(qmsg);
          await razan
...
*${prefix}hapusvote* - untuk menghapus vote`;
          ...
          razan.sendMessage(m.chat, buttonMessageVote);
        }
        break;
      case "upvote":
        {
...
*${prefix}hapusvote* - untuk menghapus vote`;
          ...
          razan.sendMessage(m.chat, buttonMessageUpvote);
        }
        break;
      case "devote":
        {
...
*${prefix}hapusvote* - untuk menghapus vote`;
          ...
          razan.sendMessage(m.chat, buttonMessageDevote);
        }
        break;
...
©${razan.user.id}
`;
        razan.sendTextWithMentions(m.chat, teks_vote, m);
        break;
      case "deletevote":
      case "delvote":
      case "hapusvote":
      ...
      case "linkgc":
        {
          if (!m.isGroup) throw mess.group;
          if (!isBotAdmins) throw mess.botAdmin;
          let response = await razan.groupInviteCode(m.chat);
          razan.sendText(
            m.chat,
      ...
      case "setnamebot":
        {
          ...
          let name = await razan.updateProfileName(text);
      ...
      case "setbotbio":
        {
          if (!text) throw `this is a WhatsApp Bot named razan-Morou`;
          let name = await razan.updateProfileStatus(text);
      ...
      case "infochat":
        {
          ...
          razan.sendTextWithMentions(m.chat, teks, m);
        }
        break;
      case "q":
      case "quoted":
      ...
      case "sgif":
        {
          if (/image/.test(mime)) {
            m.reply(mess.wait);
            let media = await razan.downloadMediaMessage(qmsg);
            let encmedia = await razan.sendImageAsSticker(m.chat, media, m, {
              packname: global.packname,
              author: global.author,
            });
            ...
            let media = await razan.downloadMediaMessage(qmsg);
            let encmedia = await razan.sendVideoAsSticker(m.chat, media, m, {
              packname: global.packname,
              author: global.author,
            });
            await fs.unlinkSync(encmedia);
      ...
      case "emojimix":
        {
          ...
          for (let res of anu.results) {
            let encmedia = await razan.sendImageAsSticker(m.chat, res.url, m, {
              packname: global.packname,
              author: global.author,
              categories: res.tags,
            });
      ...
      case "stikermeme":
        {
          ...
          let dwnld = await razan.downloadMediaMessage(qmsg);
          ...
          let FaTiH = await razan.sendImageAsSticker(m.chat, smeme, m, {
            packname: global.packname,
            author: global.auhor,
          });
      ...
      case "toimg":
        {
          ...
          exec(`ffmpeg -i ${media} ${ran}`, (err) => {
            ...
            razan.sendMessage(m.chat, { image: buffer }, { quoted: m });
            fs.unlinkSync(ran);
          });
        }
        break;
      ...
      case "remove-bg":
        {
          ...
          localFile = await razan.downloadAndSaveMediaMessage(qmsg, hmm);
...
🔗 *Media Url* : ${images}`,
            ...
            razan.sendMessage(m.chat, buttonMessage, { quoted: m });
          });
        }
        break;
      case "play":
      ...
      case "shio":
        {
          ...
          if (anu.status == false) return m.reply(anu.message);
          razan.sendText(m.chat, `⭔ *Hasil :* ${anu.message}`, m);
        }
        break;
      case "stalker":
      case "stalk":
      ...
      case "tiktoknowm":
        {
          ...
          m.reply(mess.wait);
          let anu = await fetchJson(
            `https://api.razan.my.id/api/dowloader/tikok?url=${text}&apikey=Razan123`
          );
          let buttons = [
            {
      ...
      case "tiktokaudio":
        {
          ...
          let msg = await razan.sendMessage(m.chat, buttonMessage, {
            quoted: m,
          });
          razan.sendMessage(
            m.chat,
      ...
      case "getmsg":
        {
          ...
          razan.copyNForward(m.chat, msgs[text.toLowerCase()], true);
        }
        break;
      case "listmsg":
        {
...
${cpus
  ...
  .join("\n\n")}`
    : ""
      ...
      case "creator":
        {
          razan.sendContact(m.chat, global.owner, m);
        }
        break;
      case "playstore":
        {
...
⭔ Detail: ${detail}`;
          razan.sendImage(m.chat, thumb, capt, m);
        }
        break;
      case "jadwalbioskop":
        {
          ...
          razan.sendImage(m.chat, res.result[0].thumb, capt, m);
        }
        break;
      case "nowplayingbioskop":
        {
          ...
          razan.sendImage(m.chat, res.result[0].img, capt, m);
        }
        break;
      case "aminio":
        {
      ...
      case "drakor":
        {
          ...
          razan.sendImage(m.chat, res.result[0].thumbnail, capt, m);
        }
        break;
      case "setmenu":
        {
...
└───────⭓`;
          let btn = [
            {
              urlButton: {
                displayText: "Source Code",
                url: "https://github.com/razn-id/Razanbot-Md",
              },
            },
            {
              callButton: {
                displayText: "Number Phone Owner",
                phoneNumber: "+62 857-3680-0927",
              },
            },
            {
              quickReplyButton: {
          ...
          if (setbot.templateImage) {
            ...
            razan.send5ButMsg(m.chat, anu, razan.user.name, btn);
          } else if (setbot.templateLocation) {
            razan.send5ButLoc(m.chat, anu, razan.user.name, global.thumb, btn);
          }
        }
        break;
      default:
        ...
        if (isCmd && budy.toLowerCase() != undefined) {
          ...
          razan.copyNForward(m.chat, msgs[budy.toLowerCase()], true);
        }
    }
  } catch (err) {
